<?php
    ...
    if($shams_solar_slider_layout == 'Left'){
		$shams_solar_custom_css .='#slider .carousel-caption, #slider .inner_carousel, #slider .inner_carousel h1, #slider .inner_carousel p, #slider .readbutton{';
			$shams_solar_custom_css .='text-align:left !important; left:15%; right:45%;';
		$shams_solar_custom_css .='}';
		$shams_solar_custom_css .='
		...
		$shams_solar_custom_css .='#slider .carousel-caption, #slider .inner_carousel, #slider .inner_carousel h1, #slider .inner_carousel p, #slider .readbutton{';
			$shams_solar_custom_css .='text-align:center!important; left:20%; right:20%;';
		$shams_solar_custom_css .='}';
		$shams_solar_custom_css .='
		...
		$shams_solar_custom_css .='#slider .carousel-caption, #slider .inner_carousel, #slider .inner_carousel h1, #slider .inner_carousel p, #slider .readbutton{';
			$shams_solar_custom_css .='text-align:right!important; left:45%; right:15%;';
		$shams_solar_custom_css .='}';
		$shams_solar_custom_css .='
